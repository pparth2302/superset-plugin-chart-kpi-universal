...
exports.default = KpiUniversalChart;
...
function KpiUniversalChart(props) {
  var themeTokens = (0, _styles.resolveThemeTokens)(props.theme);
  ...
  var cardStyle = (0, _styles.buildCardShellStyle)({
    width: props.width,
    height: props.height,
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    style: cardStyle
  }, (props.showTitle || props.showInfoIcon) && /*#__PURE__*/_react.default.createElement("div", {
    style: {
  ...
  }, props.showTitle ? props.title : ''), props.showInfoIcon && /*#__PURE__*/_react.default.createElement(InfoIcon, {
  ...
  }, props.formattedValue)), rightColumnVisible && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      alignItems: 'stretch',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, props.showTrend && props.trend && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      alignItems: 'center',
      color: themeTokens.secondaryTextColor,
      display: 'flex',
  ...
  }, props.trend.label)), sparklineVisible && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      height: Math.max(44, Math.round(props.height * 0.26)),
      marginTop: 12,
      width: '100%'
    }
  }, /*#__PURE__*/_react.default.createElement(_EchartsSparkline.default, {
