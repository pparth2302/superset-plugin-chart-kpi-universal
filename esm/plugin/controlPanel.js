...
import { DEFAULT_BORDER_RADIUS, DEFAULT_CARD_PADDING, DEFAULT_DECIMAL_PRECISION, DEFAULT_DURATION_UNIT, DEFAULT_KPI_AGGREGATION_MODE, DEFAULT_KPI_SOURCE_MODE, DEFAULT_KPI_VALUE_FONT_SIZE, DEFAULT_ROW_LIMIT, DEFAULT_SPARKLINE_FILL_OPACITY, DEFAULT_SPARKLINE_LINE_WIDTH, DEFAULT_TITLE_FONT_SIZE, DEFAULT_TREND_CALCULATION_MODE, DEFAULT_TREND_FONT_SIZE, DEFAULT_TREND_LABEL_PREFIX, DEFAULT_TREND_MEANING, DEFAULT_VALUE_COLUMN_WIDTH_PERCENT } from '../constants';
var granularityControl = sharedControls.granularity_sqla || sharedControls.series || {};
var timeGrainControl = sharedControls.time_grain_sqla || {};
var metricControl = sharedControls.metric || sharedControls.metrics || {};
var controlPanel = {
  controlPanelSections: [{
    ...
    controlSetRows: [[{
      ...
      config: _extends({}, granularityControl, {
        label: t('Time column'),
        clearable: true,
        description: t('Optional temporal column used for sparkline generation and time-series-derived KPI calculations.')
      })
    }, {
      ...
      config: _extends({}, metricControl, {
        ...
        clearable: true,
        description: t('Optional aggregate metric used when trend mode is set to secondary metric.')
      })
    }], [{
      ...
      config: {
        ...
        clearable: false,
        renderTrigger: true,
        description: t('Choose whether the large KPI value is derived from the time series or from the aggregate metric query.'),
        choices: [['time_series', t('Time series')], ['direct_metric', t('Direct metric')]]
      }
    }, {
      name: 'row_limit',
      config: {
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        renderTrigger: true,
        description: t('Optional title override. If left empty, the primary metric label is used.')
      }
    }], [{
      name: 'show_title',
      config: {
      ...
      config: {
        ...
        renderTrigger: true,
        description: t('Superset number format string used for numeric values when Value type mode is number.')
      }
    }, {
      ...
      config: {
        ...
        clearable: false,
        renderTrigger: true,
        choices: [['auto', t('Auto')], ['number', t('Number')], ['percent', t('Percent')], ['duration', t('Duration')]]
      }
    }, {
      name: 'duration_unit',
      config: {
        ...
        clearable: false,
        renderTrigger: true,
        description: t('Used when duration values are numeric rather than already formatted as HH:MM:SS.'),
        choices: [['seconds', t('Seconds')], ['milliseconds', t('Milliseconds')]]
      }
    }], [{
      ...
      config: {
        ...
        clearable: false,
        renderTrigger: true,
        description: t('Applied when KPI source mode is set to time series. Direct metric mode uses the aggregate query result directly.'),
        choices: [['latest', t('Latest')], ['sum', t('Sum')], ['average', t('Average')], ['min', t('Min')], ['max', t('Max')]]
      }
    }], [{
      name: 'enable_trend',
      config: {
      ...
      config: {
        ...
        clearable: false,
        renderTrigger: true,
        choices: [['first_vs_last_percent', t('First vs last percent')], ['previous_vs_latest_percent', t('Previous vs latest percent')], ['absolute_difference', t('Absolute difference')], ['secondary_metric', t('Secondary metric')]]
      }
    }, {
      name: 'trend_meaning',
      config: {
        ...
        clearable: false,
        renderTrigger: true,
        choices: [['higher_is_better', t('Higher is better')], ['lower_is_better', t('Lower is better')]]
      }
    }], [{
      ...
      config: {
        ...
        default: 0,
        renderTrigger: true,
        description: t('Absolute change at or below this threshold is treated as neutral.')
      }
    }], [{
      name: 'show_sparkline',
      config: {
      ...
      config: {
        ...
        clearable: false,
        renderTrigger: true,
        choices: [['area', t('Area')], ['line', t('Line')]]
      }
    }, {
      ...
      config: {
        ...
        isInt: true,
        renderTrigger: true,
        description: t('Controls the left-versus-right width split between the KPI text and the trend/sparkline area.')
      }
    }]]
